const CACHE='toreca-vault-v13';
const ASSETS=['./','./index.html','./styles.css','./js/app.js','./js/presentation.js','./js/ui-enhancements.js','./js/remote-sync.js','./js/schema.js','./js/storage.js','./js/calculations.js','./js/inventory.js','./market-update.json','./manifest.webmanifest','./assets/icon.svg'];
