const CACHE='toreca-vault-v8';
const ASSETS=['./','./index.html','./styles.css','./js/app.js','./js/schema.js','./js/storage.js','./js/calculations.js','./js/inventory.js','./market-update.json','./manifest.webmanifest','./assets/icon.svg'];
